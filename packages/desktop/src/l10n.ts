...
const en = {
  ...
  'theme.light': 'Light',
  'theme.dark': 'Dark',
  'theme.saveFailed': 'Could not save the theme preference. Your previous selection is unchanged.',
...
const ru: Catalog = {
  ...
  'theme.light': 'Светлая',
  'theme.dark': 'Тёмная',
  'theme.saveFailed': 'Не удалось сохранить тему. Предыдущий выбор не изменён.',
...
const de: Catalog = {
  ...
  'theme.light': 'Hell',
  'theme.dark': 'Dunkel',
  'theme.saveFailed': 'Die Einstellung konnte nicht gespeichert werden. Die vorherige Auswahl bleibt bestehen.',
...
const zh: Catalog = {
  ...
  'theme.light': '浅色',
  'theme.dark': '深色',
  'theme.saveFailed': '无法保存主题设置，已保留原来的选择。请检查用户数据目录是否可写。',
  'update.check': '检查更新…',
